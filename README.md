...
Desenvolvido com o objetivo de facilitar a escrita de textos utilizando símbolos e caracteres. A sua aplicação permite a criação de sites, livros, artigos, slides, documentos técnicos, sendo muito usado para formatar arquivos **README**, em mensagens em fóruns e arquivos *readme.md* do GitHub. Arquivos usando a extensão MD são usados principalmente pelo programa Markdown a partir do site oficial [Daring Fireball](Daring Farinbal).
